...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="/director/transactions">
    ...
    <li class="nav-item">
        {{-- <a class="nav-link" href="/director/vehicles">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/director/assets">All Assets</a>
                <a class="collapse-item" href="/director/assets/create">Add Asset</a>
                 <h6 class="collapse-header">Vehicles:</h6>
                <a class="collapse-item" href="/director/vehicles">Vehicles</a>
                <a class="collapse-item" href="/director/vehicles/add">Add Vehicles</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="/director/users">
