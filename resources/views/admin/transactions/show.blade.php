        ...
        <div class="card shadow mb-4">
            ...
            <form method="post" action="/admin/transactions/{{$transaction->id}}" class="user" id="approveRequestForm">
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-primary btn-icon-split @if($transaction->director_id == null) disabled @endif" href="/admin/transactions/{{$transaction->id}}/edit">
                        <span class="icon text-white-50">
                    ...
                    @if($transaction->status_id == 3)
                        <form action="/admin/transactions/{{$transaction->id}}" method="POST">
                            @csrf
                            @method('patch')
                            <input type="text" name="type" class="d-none" value="deploy">
